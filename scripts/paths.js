...
console.log('Local Url '.bold.yellow + returnPath('http://localhost:8080/thrashers/' + podcasts[selectedPodcast].handle + '/source.json'));
console.log('Remote Url '.bold.green + returnPath('https://interactive.guim.co.uk/podcasts/thrashers/' + podcasts[selectedPodcast].handle + '/source.json'));

console.log('\nPodcard'.rainbow.bold.underline.inverse);
console.log('Local Url '.bold.yellow + returnPath('http://localhost:8080/snap/' + podcasts[selectedPodcast].handle + '/source.json'));
console.log('Remote Url '.bold.green + returnPath('https://interactive.guim.co.uk/podcasts/snap/' + podcasts[selectedPodcast].handle + '/source.json'));
